      ...
      <div class="row">
        ...
        <table class="table table-bordered" style="background-color: white;">
            ...
            <tbody>
                ...
                <?php 
                $ambil = $koneksi->query ("SELECT * FROM tbl_produk WHERE kode_barang='$kode_barang'");
                $data_barang = $ambil -> fetch_assoc();

                $jumlah = $_SESSION['check'][$kode_barang];
                    
                $subharga = $data_barang["harga"]*$jumlah;
                ...
                <tr>
                    ...
                    <!--<td> <a href="hapusproduk.php?kode=<?php// echo $kode_barang?>" class="btn btn-danger">Hapus</a></td>-->
                </tr>
                <?php $nomer++;?>
                <?php $total+= $subharga;?>
                <?php endforeach ?>
        ...
        <hr><a href="#" class="btn btn-primary"> Pembayaran </a>
        </form>
