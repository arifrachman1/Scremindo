<?php  
session_start();
if (!isset($_SESSION["login"]) || !isset($_SESSION["login_nama_admin"]) ) {
...
$admin = query("SELECT * FROM tbl_admin LIMIT $awalData, $jumlahDataPerHalaman");

if(isset($_POST["cari_admin"])){
  $admin = cari_admin($_POST["keyword_admin"]);
}
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="index.php"><i class="fa fa-circle"></i> Admin</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/transaksi/transaksi.php"><i class="fa fa-circle-o"></i> Transaksi</a></li>
            <li><a href="pages/transaksi/report.php"><i class="fa fa-circle-o"></i> Laporan Hasil Penjualan</a></li>
          </ul>
        </li>
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li ><a href="pages/customer/customer.php"><i class="fa fa-circle-o"></i> Customer</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="container">
       <a href="register.php" class="btn btn-success btn-lg">Tambah Admin</a> <br><br>
      </div>
    ...
    <div class="table-responsive">
      <table class="table table-hover" style="width: 100; background-color:   #eafffc">
          ...
          <tr style="background-color: #5cb85c;">
            ...
            <th style="width: 12%;" class="text-center">Foto Admin</th>
          ...
          <tr>           
            <td><?= $i ?></td>
            <td><?= $row["nama"]; ?></td>
            <td><img src="img/admin/<?= $row["foto_admin"]; ?>" width="100%"></td>
            ...
            <td><?= $row["email"]; ?></td>
            <td><center>
             <a href="ubah_admin.php?id=<?= $row["kode_admin"]; ?>"><button class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></button></a>
             <a href="hapus_admin.php?id=<?= $row ["kode_admin"]; ?>" onclick="return confirm('yakin ?')"><button class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></button></a>
            </center></td>
          </tr>
          <?php $i++; ?>
          <?php endforeach; ?>
