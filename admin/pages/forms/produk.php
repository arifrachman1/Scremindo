...
$produk = query("SELECT * FROM tbl_produk LIMIT $awalData, $jumlahDataPerHalaman");

if(isset($_POST["cari_produk"])){
  $produk = cari_produk($_POST["keyword_produk"]);
}
...
<head>
  ...
  <title>Admin | Tambah_Produk</title>
...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="produk.php"><i class="fa fa-circle"></i> Tambah Produk</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="produk.php"><i class="fa fa-edit"></i> Form</a></li>
        <li class="active">Tambah Produk</li></a>
      </ol><br>

      <div class="container">
       <a href="tambah_produk.php" class="btn btn-success btn-lg">Tambah Data</a> <br><br>
      </div>
        ...
        <div class="table-responsive">
          <table class="table " style="width: 100; background-color:   #eafffc " >
            ...
            <tr  style="background-color: #5cb85c;">
              ...
              <th style="width: 16%;" class="text-center">Foto Produk</th>
              <th class="text-center">Stok</th>
              <th class="text-center">Harga</th>
              <th style="width: 10%;" class="text-center">Tanggal Pembuatan</th>
              <th style="width: 10%;" class="text-center">Tanggal Kadaluarsa</th>
            ...
            <tr>
              ...
              <td class="text-center"><img src="../../img/produk/<?= $row["foto_produk"]; ?>" width="100%"></td>
              <td class="text-center"><?= $row["stok"]; ?></td> 
              <td class="text-center"><?= $row["harga"]; ?></td>
              <td class="text-center"><?= $row["tgl_pembuatan"]; ?></td>
              <td class="text-center"><?= $row["tgl_kadaluarsa"]; ?></td>
              <td class="text-center"><?= $row["detail_produk"]; ?></td>
               <td><center>
                <a href="ubah_produk.php?id=<?= $row["kode_produk"]; ?>"><button class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></button></a>
               <a href="hapus_produk.php?id=<?= $row ["kode_produk"] ?>" onclick="return confirm('yakin ?')"><button class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></button></a>
              </center></td>
            <?php $i++; ?>
            <?php endforeach; ?>
          </table>
