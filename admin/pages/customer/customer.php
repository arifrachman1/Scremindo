...
$jumlahData = count(query("SELECT * FROM tbl_customer"));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
$halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
$awalData = ($jumlahDataPerHalaman * $halamanAktif) - $jumlahDataPerHalaman;

$customer = query("SELECT * FROM tbl_customer LIMIT $awalData, $jumlahDataPerHalaman");
...
<div class="wrapper">
    ...
    <section class="sidebar ">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="costumer.php"><i class="fa fa-circle"></i> Customer</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="customer.php"><i class="fa fa-edit"></i> Form</a></li>
    ...
    <div class="table-responsive">
      <table class="table " style="width: 100; background-color:   #eafffc " >
          ...
          <tr style="background-color: #5cb85c;">
            ...
            <th style="width: 12%;" class="text-center">Tempat Lahir</th>
          ...
          <tr>
            ...
            <td><?= $row["password"]; ?></td>
            <td><center>
             <a href="hapus_customer.php?id=<?= $row ["id_customer"]; ?>" onclick="return confirm('yakin ?')"><button class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></button></a>
            </center></td>
          </tr>
          <?php $i++; ?>
          <?php endforeach; ?>
          ...
          <div class="container col-sm-6 col-sm-offset-4">
            ...
            <?php if($halamanAktif > 1) : ?>
              <li><a href="?halaman=<?= $halamanAktif -1 ?>"> PREVIOUS</a></li>
            <?php endif; ?>  
            <?php for($h = 1; $h <= $jumlahHalaman; $h++) : ?>
              <?php if($h == $halamanAktif) : ?>
                <li class="active"><a href="?halaman=<?= $h; ?>" ><?= $h; ?> </a></li>
              <?php else : ?>
                <li><a href="?halaman=<?= $h; ?>"><?= $h; ?></a></li>  
              <?php endif; ?>
            <?php endfor; ?>  
            <?php if($halamanAktif < $jumlahHalaman) : ?>
              <li><a href="?halaman=<?= $halamanAktif +1 ?>"> NEXT</a></li>
            <?php endif; ?> 
          </ul>
          </div>
        </div>
