...
$jumlahData = count(query("SELECT * FROM tbl_transaksi"));
$jumlahHalaman = ceil($jumlahData / $jumlahDataPerHalaman);
$halamanAktif = (isset($_GET["halaman"])) ? $_GET["halaman"] : 1;
$awalData = ($jumlahDataPerHalaman * $halamanAktif) - $jumlahDataPerHalaman;


$transaksi = query("SELECT * FROM tbl_transaksi LIMIT $awalData, $jumlahDataPerHalaman");
 ?>
...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview ">
         ...
         <li class="treeview active">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="transaksi.php"><i class="fa fa-circle"></i> Transaksi</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="transaksi.php"><i class="fa fa-edit"></i> Form</a></li>
        ...
        <div class="table-responsive">
          <table class="table" style="width: 100; background-color: #eafffc">
            ...
            <tr style="background-color: #5cb85c;">
              ...
              <th style="width: 16%;" class="text-center">Foto Bukti Pembayaran</th>
            ...
            <tr>
              ...
              <td class="text-center"><img src="../../img/bukti_bayar/<?php echo $row["foto_bukti_pembayaran"]; ?>" width="100%"></td>
              <td class="text-center"><?= $row["keterangan"]; ?></td> 
              <td><center>
                <a href="ubah_transaksi.php?id=<?= $row["kode_transaksi"]; ?>"><button class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></button></a>
                <a href="hapus_transaksi.php?id=<?= $row ["kode_transaksi"] ?>" onclick="return confirm('yakin ?')"><button class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></button></a>
              </center></td>
            </tr>
            <?php $i++; ?>
            <?php endforeach; ?>
